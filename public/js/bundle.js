    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://127.0.0.1:3000/api/v1/articles/submit-new-article",
            data: {
...
if (newArticleForm) newArticleForm.addEventListener('submit', function (e) {
  e.preventDefault();
  imageCover = imageCover.textContent;
...
},{"./login.js":"login.js","./newArticle.js":"newArticle.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
